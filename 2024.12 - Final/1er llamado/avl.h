...
/**
 * Retorna el dato pasado si se encuentra y NULL en caso contrario
 */
void *avl_buscar_dato(AVL, void *);
...
/**
 * Elimina un dato del árbol, manteniendo la propiedad de los arboles AVL. No hace nada si el dato no se encuentra en el árbol.
 */
